...
class TestApp:
    ...
    def setup_class(self):
        """Setup class by defining docstrings."""
        ...
        self.EXPECTED_PATCH = textwrap.dedent(f'''\
            {self.PATCH_PREFIX}
    ...
    def test_stdin_patch_mode(self):
    ...
    def test_run_on_stdin_overwrite(self):
    ...
    def test_overwrite_files_the_same(self):
    ...
    def test_overwrite_files_different(self):
    ...
    def test_patch_files_the_same(self):
    ...
    def test_patch_files_different(self):
